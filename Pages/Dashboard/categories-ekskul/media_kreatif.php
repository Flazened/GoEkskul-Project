...
// 4. Query Ambil semua data ekskul KHUSUS KATEGORI MEDIA KREATIF
$category_name = 'MEDIA KREATIF';
    ...
    <main class="dashboard-main-content">
        ...
        <section class="dashboard">
            ...
            <section class="ekskul-list">
                ...
                <?php 
                // Looping untuk menampilkan setiap ekskul kategori MEDIA KREATIF
