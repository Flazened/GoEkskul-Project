...
// 4. Query Ambil semua data ekskul KHUSUS KATEGORI ECONOMY BUSINESS
$category_name = 'ECONOMY BUSINESS';
    ...
    <main class="dashboard-main-content">
        ...
        <section class="dashboard">
            ...
            <section class="ekskul-list">
                ...
                <?php 
                // Looping untuk menampilkan setiap ekskul kategori ECONOMY BUSINESS
