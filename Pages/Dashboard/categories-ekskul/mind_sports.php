<?php
session_start();
// Path include disesuaikan (naik 3 level ke root, lalu masuk Config)
...
// 4. Query Ambil semua data ekskul KHUSUS KATEGORI MIND SPORTS
$category_name = 'MIND SPORTS';
    ...
    <main class="dashboard-main-content">
        ...
        <section class="dashboard">
            ...
            <section class="ekskul-list">
                ...
                <?php 
                // Looping untuk menampilkan setiap ekskul kategori MIND SPORTS
                if ($total_ekskul_count > 0) {
                    ...
                    echo "<p style='text-align: center; margin-top: 20px;'>Belum ada ekskul untuk kategori **" . htmlspecialchars($category_name) . "**.</p>";
                }
                ?>
