...
<head>
    ...
    <link rel="stylesheet" href="/Styles/Dashboard/Dashboard-Guru/setting.css">
</head>
    ...
    <section class="dashboard">
        ...
        <section class="Uni">
            ...
            <div class="Foto-Profil">
                <img src="../../../Images/Profil-1.png" alt="Foto Profil" class="profile-picture">
            </div>
                <!-- Form Profil -->
                <form class="profile-form">
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <input type="text" value="Alex Fischer" readonly>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Kelas</label>
                            <div class="input-box">
                                <input type="text" value="Pembina" readonly>
                                <img src="/Images/Icon/Lock.png" alt="lock" class="lock-icon">
                            </div>
                        </div>
                        <div class="form-group">
