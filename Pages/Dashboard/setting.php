...
<head>
    ...
    <link rel="stylesheet" href="../../Styles/Dashboard/sigma.css">
</head>
    ...
    <section class="dashboard">
        ...
        <section class="Uni">
            <section class="bagian">
                ...
                <div class="apalaitu">
                    <a href="setting-contact.php">Kontak & Bantuan</a>
                </div>
            </section>
        </section>
            <div class="Foto-Profil">
                <img src="../../Images/Profil.png" alt="Foto Profil" class="profile-picture">
            </div>
                <!-- Form Profil -->
                <form class="profile-form">
                    <div class="form-row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <input type="text" value="24 September 2009" readonly>
                                <img src="../../Images/Icon/Lock.png" alt="lock" class="lock-icon">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>Jurusan</label>
                            <div class="input-box">
                                <input type="text" value="Teknik Komputer & Jaringan" readonly>
                                <img src="../../Images/Icon/Lock.png" alt="lock" class="lock-icon">
                            </div>
                        </div>
                        <div class="form-group">
                            <label>Alamat</label>
                            <div class="input-box">
                                <input type="text" value="Jl. Parit No.2, Gg. Flamboyan 4 Ai No.11" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            <label>NIS</label>
                            <div class="input-box">
                                <input type="text" value="5043" readonly>
                                <img src="../../Images/Icon/Lock.png" alt="lock" class="lock-icon">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-box">
                                <input type="text" value="+62 897-3871-170" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="popup-box">
                    ...
                    <form action="../landing/beranda.php" method="post">
