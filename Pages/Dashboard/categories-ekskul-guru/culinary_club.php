...
// 4. Query Ambil semua data ekskul KHUSUS KATEGORI CULINARY CLUB
$category_name = 'CULINARY CLUB';
    ...
    <main class="dashboard-main-content">
        ...
        <section class="dashboard">
            ...
            <section class="ekskul-list">
                ...
                <?php 
                // Looping untuk menampilkan setiap ekskul kategori CULINARY CLUB
