<?php
session_start();
// 💡 PERBAIKAN: Path include disesuaikan (naik 3 level ke root, lalu masuk Config)
include '../../../Config/db.php'; 

// Jika user belum login, kembalikan ke halaman login
if (!isset($_SESSION['user'])) {
    header("Location: ../Auth/Sign_In.php"); // Path ini sudah benar (naik ke Dashboard, lalu ke Auth)
    exit;
}
...
// Pengecekan koneksi (dari error sebelumnya)
if (isset($koneksi)) {
...
// 3. Query Ambil semua ID ekskul yang sudah didaftarkan user ini
...
// 4. Query Ambil semua data ekskul KHUSUS KATEGORI BELA DIRI
$category_name = 'BELA DIRI';
...
<head>
    ...
    <title>GoEkskul | <?php echo htmlspecialchars($category_name); ?></title>
    ...
    <main class="dashboard-main-content">
        ...
        <section class="dashboard">
            ...
            <section class="ekskul-list">
                ...
                <?php 
                // Looping untuk menampilkan setiap ekskul kategori BELA DIRI
